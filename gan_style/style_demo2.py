...
#style_demo1++
#设置了一个 image resize 函数，这样可以处理任意size的 input image，
# 而且尝试利用 L-BFGS 优化算法替代之前的 Adam 优化算法，对卷积层以及pooling层函数做了修改
###############################################################################
...
OUTPUT_DIR = 'result/'
# Style image to use.
STYLE_IMAGE = 'images/miaosu.jpg'
# Content image to use.
CONTENT_IMAGE = 'images/枫女.jpg'
...
def get_weight_bias(vgg_layers, layer_i):
    ...
    weights = vgg_layers[layer_i][0][0][0][0][0]
    w = tf.constant(weights)
    #bias = vgg_layers[layer_i][0][0][2][0][1]
    bias = vgg_layers[layer_i][0][0][0][0][1]
